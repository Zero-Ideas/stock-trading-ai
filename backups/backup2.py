...
class StockSentimentAnalyzer:
    def __init__(self, symbol: str):
        ...
        # Update VADER with financial terms
        self.analyzer.lexicon.update(finance_lexicon)
        self.analyzer.lexicon.update(financial_context_phrases)
    ...
    def get_comprehensive_sentiment(self, target_articles: int = 50) -> List[SentimentData]:
        ...
        source_functions = [
            ...
            (self._scrape_bloomberg_search, "Bloomberg", 10),
        ]
    ...
    def _analyze_text(self, text: str) -> Dict[str, float]:
        ...
        # Enhanced VADER analysis with financial context
